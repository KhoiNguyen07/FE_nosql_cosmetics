    ...
    <footer className="bg-[#f5f5f5] text-gray-700">
      <div className="max-w-7xl mx-auto px-6 py-14" ref={rootRef}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4 text-center md:text-left" data-rev>
            <h3 className="text-3xl font-serif tracking-wide">Beauty Store</h3>
            <p className="mt-4 text-sm text-gray-500">Call us</p>
            <p className="text-3xl font-medium mt-2">(+84) 123 456 789</p>
            <div className="mt-4 text-sm text-gray-500 space-y-1">
              <p>123 Beauty Street, District 1, Ho Chi Minh City</p>
              <p>info@cosmeticsstore.com</p>
              <p>Fax: (+84) 28 1234 5678</p>
            </div>
          </div>
          {/* Middle columns: info / services / account */}
          <div className="md:col-span-5 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div data-rev>
              <h4 className="uppercase text-sm mb-4">Information</h4>
            ...
            <div data-rev>
              <h4 className="uppercase text-sm mb-4">Services</h4>
              <ul className="space-y-3 text-sm text-gray-600">
                {[
                  "Free Shipping",
                  "Beauty Consultation",
            ...
            <div data-rev>
              <h4 className="uppercase text-sm mb-4">My Account</h4>
              <ul className="space-y-3 text-sm text-gray-600">
                {[
                  "Sign In",
                  "Register",
          ...
          <div className="md:col-span-3 text-center md:text-left" data-rev>
            <h4 className="uppercase text-sm mb-4">Newsletter</h4>
            <p className="text-sm text-gray-500">
              Subscribe to get updates on new products and exclusive offers
            </p>
            <form
              onSubmit={handleSubmit}
              className="mt-4 flex flex-col sm:flex-row items-center"
            >
              <input
                type="text"
                placeholder="Enter your email"
                className="w-full sm:flex-1 px-4 py-3 border border-gray-200 rounded-md sm:rounded-l-md focus:outline-none"
                value={email}
              ...
              <button
                ...
                className="mt-3 sm:mt-0 sm:ml-2 w-full sm:w-auto bg-black text-white px-4 py-3 rounded-md"
              >
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
          ...
          <div className="flex items-center gap-4 text-2xl text-gray-400 mt-4 md:mt-0 justify-center md:justify-end">
