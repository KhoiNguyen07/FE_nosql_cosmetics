      ...
      <div className="w-full overflow-hidden">
        <div className="group relative">
          <div className="w-[300px] h-[300px] overflow-hidden rounded">
            <img
              src={firstImage}
              alt={name}
              className="cursor-pointer w-full h-full object-cover transition-opacity duration-500 ease-in-out group-hover:opacity-0"
            />
            <img
              onClick={handleToDetailProduct}
              src={secondImage}
              alt={name}
              className="cursor-pointer w-full h-full object-cover absolute top-0 left-0 transition-opacity duration-500 ease-in-out opacity-0 group-hover:opacity-100"
            />
          </div>
          {/* sidebar on hover */}
          <div
        ...
        {!addCartBtn ? (
          <div className="flex flex-col justify-center space-y-2">
            <h2 className="text-xl mt-3 max-w-[300px] truncate" title={name}>
              {name}
            </h2>
